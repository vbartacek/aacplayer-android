...
public final class DirectFFMPEGDecoder extends DirectDecoder {

    private static final String LOG = "DirectFFMPEGDecoder";
     ...
     */
    public static synchronized DirectFFMPEGDecoder create() {
        if (!libLoaded) {
        ...
        return new DirectFFMPEGDecoder();
    }
