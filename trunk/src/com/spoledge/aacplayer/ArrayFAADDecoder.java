...
public final class ArrayFAADDecoder extends ArrayDecoder {

    private static final String LOG = "ArrayFAADDecoder";
     ...
     */
    public static synchronized ArrayFAADDecoder create() {
        if (!libLoaded) {
            System.loadLibrary( "aacfaad2arr" );

            libLoaded = true;
        }

        return new ArrayFAADDecoder();
    }
