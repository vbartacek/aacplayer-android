...
public final class ArrayOpenCOREDecoder extends ArrayDecoder {

    private static final String LOG = "ArrayOpenCOREDecoder";
     ...
     */
    public static synchronized ArrayOpenCOREDecoder create() {
        if (!libLoaded) {
            System.loadLibrary( "aacopencore-aacdecarr" );

            libLoaded = true;
        }

        return new ArrayOpenCOREDecoder();
    }
