...
public final class DirectFAADDecoder extends DirectDecoder {

    private static final String LOG = "DirectFAADDecoder";
     ...
     */
    public static synchronized DirectFAADDecoder create() {
        if (!libLoaded) {
